document.body.innerHTML+='<canvas contentEditable="false" id="can" style="border-radius: 0em; font-family: initial; margin: unset; margin-inline: unset; margin-block: unset; z-index:65534;background-color: transparent; position:absolute; top:0px;left:0px;width:100%;height:100%;"></canvas>  <aa contentEditable="false" id="expandedit" style="border-radius: 0em; font-family: initial; margin: unset; margin-inline: unset; margin-block: unset; pointer-events: none; z-index:65535; background-color: #FFFFFF;position:fixed;top:0px;left:0px;width: 80px;height:20px;">&nbspEdit+</aa>  <button contentEditable="false" id="drawtoggl" onclick="drawtoggle()" style="border-radius: 0em; font-family: initial; margin: unset; margin-inline: unset; margin-block: unset; background-color:#C80000;z-index:65535;position:fixed;top: 0px; width: 20px;height: 20px;padding: 0px 0px 0px 0px;left: 40px; border-color:#CCCCCC"></button>  <button contentEditable="false" id="texttoggl" onclick="texttoggle()" style="border-radius: 0em; font-family: initial; margin: unset; margin-inline: unset; margin-block: unset; background-color:#C80000;z-index:65535;position:fixed;top: 0px; width: 20px;height: 20px;padding: 0px 0px 0px 0px;left: 60px; border-color:#CCCCCC"></button>  <aa contentEditable="false" id="drawicon" style="border-radius: 0em; font-family: initial; margin: unset; margin-inline: unset; margin-block: unset; pointer-events: none; z-index:65536; position:fixed;top: -2px;left: 42px;">✎</aa>  <aa contentEditable="false" id="texticon" style="border-radius: 0em; font-family: initial; margin: unset; margin-inline: unset; margin-block: unset; pointer-events: none; z-index:65536; position:fixed;top: -2px;left: 65px; font-size: 19px;">T</aa>  <sub id="others" style="border-radius: 0em; font-family: initial; margin: unset; margin-inline: unset; margin-block: unset; display:none;">    <button contentEditable="false" id="colortoggl" onclick="colortoggle()" style="background-color:#00C800;z-index:65535;position:fixed;top: 0px; width: 63px;height: 20px;padding: 0px 0px 0px 0px;left: 105px; border-color:#CCCCCC"><aa id="modetype" style="pointer-events: none; z-index:65536; position:fixed;top: 2px;left: 113px;"></aa></button>      </sub>    <sub contentEditable="false" id="recolor" style="display: none;">    <button onclick="switchleft()" id="switchleft" style="z-index: 65535; position:fixed;top: 20px;left: 0px; background-color: #C8C8C8; border-style: inlet; width: 10px; height: 20px; padding: 0px 0px 0px 0px"><</button>    <button onclick="sub10()" id="firstonesub" style="z-index: 65535; position:fixed;top: 20px;left: 10px; background-color: #C8C8C8; border-style: inlet; width: 20px; height: 10px; padding: 0px 0px 0px 0px; text-align: center"><aa style="position: fixed; left: 14px; top: 16px;">- -</aa></button>    <button onclick="sub1()" id="firsttensub" style="z-index: 65535; position:fixed;top: 30px;left: 10px; background-color: #C8C8C8; border-style: inlet; width: 20px; height: 10px; padding: 0px 0px 0px 0px; text-align: center"><aa style="position: fixed; left: 18px; top: 26px;">-</aa></button>    <aa style="z-index: 65535; position:fixed;top: 20px;left: 30px; background-color: #FFFFFF; border-style: outlet; width: 22px; height: 20px; font-size: 20px; text-align: center;"><aa id="hexfirst" style="z-index: 65535; position:fixed;top: 20px; left: 30px; width: 11px; height: 20px; font-size: 20px; text-align: center;">0</aa><aa id="hexsecond" style="z-index: 65535; position:fixed;top: 20px; left: 40px; width: 11px; height: 20px; font-size: 20px; text-align: center;">0</aa></aa>    <button onclick="add10()" id="firstoneadd" style="z-index: 65535; position:fixed;top: 20px;left: 52px; background-color: #C8C8C8; border-style: inlet; width: 20px; height: 10px;"><aa style="position: fixed; left: 54px; top: 16px;">++</aa></button>    <button onclick="add1()" id="firsttenadd" style="z-index: 65535; position:fixed;top: 30px;left: 52px; background-color: #C8C8C8; border-style: inlet; width: 20px; height: 10px;"><aa style="position: fixed; left: 58px; top: 26px;">+</aa></button>    <button onclick="switchright()" id="switchright" style="z-index: 65535; position:fixed;top: 20px;left: 72px; background-color: #C8C8C8; border-style: inlet; width: 10px; height: 20px; padding: 0px 0px 0px 0px">></button><aa style="z-index: 65535; position:fixed;top: 20px;left: 82px; background-color: #FFFFFF; border-style: outlet; width: 12px; height: 20px; font-size: 20px; text-align: center;">#</aa><dive id="erase" style="z-index: 65535; position:fixed;top: 20px;left: 94px; background-color: #FFFFFF; border-style: none; max-width: 90px; height: 20px; font-size: 20px; text-align: left;"><aa style="position: relative; left: 0px; color: #AAAA00;" id="hextwo">00</aa><aa style="position: relative; left: 0px;" id="hexfour">00</aa><aa style="position: relative; left: -0px;" id="hexsix">00</aa></dive></sub>  <img contentEditable="false" id="canvasimg" style="position:absolute;top:0px;left:0px;width:100%;length:100%;display:none;">';
